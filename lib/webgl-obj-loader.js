(function (scope, undefined) {
  ...
  var _buildColorBuffer = function (gl, color, count) {
    // var color = [3/255.0, 186/255.0, 73/255.0, 1];
    var colors = [];
    ...
    return _buildBuffer(gl, gl.ARRAY_BUFFER, colors, 4);
  }
  /**
